...
import com.tencent.devops.openapi.pojo.permission.ApigwBatchHandoverMembersReq
import com.tencent.devops.openapi.pojo.permission.ApigwBatchOperateCheckReq
import com.tencent.devops.openapi.pojo.permission.ApigwBatchRemoveMembersReq
import com.tencent.devops.openapi.pojo.permission.ApigwBatchRenewalMembersReq
import com.tencent.devops.openapi.pojo.permission.ApigwRemoveMemberFromProjectReq
...
class ApigwAuthMemberResourceV4Impl @Autowired constructor(
    ...
    override fun batchRenewalMembers(
        ...
        userId: String,
        projectId: String,
        request: ApigwBatchRenewalMembersReq
    ): Result<Boolean> {
        logger.info(
    ...
    override fun batchRemoveMembers(
        ...
        userId: String,
        projectId: String,
        request: ApigwBatchRemoveMembersReq
    ): Result<Boolean> {
        logger.info(
            "OPENAPI_AUTH_MEMBER_V4" +
                " batchRemoveMembers" +
    ...
    override fun batchOperateMembersCheck(
        ...
        request: ApigwBatchOperateCheckReq
    ...
    override fun batchHandoverMembers(
        ...
        userId: String,
        projectId: String,
        request: ApigwBatchHandoverMembersReq
    ): Result<Boolean> {
        logger.info(
            "OPENAPI_AUTH_MEMBER_V4" +
    ...
    override fun removeMemberFromProject(
        ...
        userId: String,
        projectId: String,
        request: ApigwRemoveMemberFromProjectReq
